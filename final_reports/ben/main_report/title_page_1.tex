...
//and n is strictly greater than 0
 ...
 \subsection{Feasibility analysis}
  \subsubsection{Parallelization approaches on the CPU}
  ...
  400 MiB/s and decompression throughputs of around 600 MiB/s on a 16 core test. This is a lot slower than the required throughput of 5 GiB/s. The failure of this approach in a CPU environment however, does not necessarily 
  preclude a similar approach on a GPU. It has been shown \cite{harris2007parallel} that a prefix sum can be computed up to 6 times faster on a GPU for large arrays of 16.7 million elements. 
  \subsubsection{Compression and alternative linear predictors}
  {\color{red}TODO} 
