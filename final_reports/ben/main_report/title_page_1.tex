...
Next a detailed breakdown of the most commonly used compression techniques is given. Thereafter we will then discuss a detailed design of a predictive compression scheme, 
...
\begin{enumerate}
 ...
 In the context of the packing scheme proposed here we define the scan over the normal integer addition operator. An example of this will be $scan[2,1,3,4] = [0,2,3,6,10]$ 
...
is signal frequency (as we mentioned in the background section the telescope array will monitor a wide range of frequencies). The third dimension is a combination of two 
...
\end{verbatim}
 \subsection{Algorithm parallelization}
  {\color{red}TODO}
 \subsection{Implementation using SSE and XOP} 
  {\color{red}TODO}
